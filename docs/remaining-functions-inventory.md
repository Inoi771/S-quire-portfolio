...
| 分類 | 件数 | 内訳 |
|------|------|------|
| ✅ Workers 化済み | 約 114 | 旧台帳掲載 98 + 旧台帳未掲載 16 |
| **未移行 A** | **8** | ocrAndSaveGradeSheet, parseGradeDataFromText, parseAndSaveAveragesFromText, generateGradeAnalysis, generateAllAnalyses, requestAIAssistant, executeAiAction, generateImageWithImagen（残り 8 件・うち AI 系 全件） |
...
### 次の Workers 化候補（Phase 6-C-06 以降）
