...
| **未移行 A** | **7** | ocrAndSaveGradeSheet, parseGradeDataFromText, generateGradeAnalysis, generateAllAnalyses, requestAIAssistant, executeAiAction, generateImageWithImagen（残り 7 件・うち AI 系 全件） |
...
### 次の Workers 化候補（Phase 6-C-07 以降）
