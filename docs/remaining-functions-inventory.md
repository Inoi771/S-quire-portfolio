...
| 分類 | 件数 | 内訳 |
|------|------|------|
| ✅ Workers 化済み | 約 111 | 旧台帳掲載 95 + 旧台帳未掲載 16 |
| **未移行 A** | **13** | ocrAndSaveGradeSheet, parseGradeDataFromText, parseAndSaveAveragesFromText, ocrAndExtractAverages, generateGradeAnalysis, generateAllAnalyses, requestAIAssistant, executeAiAction, ocrLectureSchedule, parseLectureScheduleFromText, generateImageWithImagen, transcribeAndSummarizeAudio, mergeTranscriptsAndSummarize（残り 13 件・うち AI 系 12 件） |
...
### 次の Workers 化候補（Phase 6-C-03 以降）
