  ...
  try {
    ...
    try {
      ...
      if (lecKeywords.test(resolvedUserMessage)) {
        ...
        var userPreferredCampuses = (userProfile && userProfile.preferredCampuses) || [];
        var userCampus = userPreferredCampuses.length > 0 ? userPreferredCampuses[0] : '';
...
- 任意: durationSlots（コマ数、10分単位。デフォルト9=90分）、classLabel（A/B/Cなど）
- 【現在の講習エントリ】にlectureIdとcampusCodeが記載されている場合はそれを使う。記載がなければ聞き返す
- 教科名は「国語」「数学」「英語」「理科」「社会」などそのまま使う
{"success":true,"type":"app_action","action":"create_lecture_entry","needsConfirmation":true,"lectureId":"講習ID","campusCode":"校舎コード2桁","date":"YYYY-MM-DD","startTime":"HH:MM","durationSlots":9,"subject":"教科名","grade":"学年コード2桁","classLabel":"クラス（省略可）","message":"以下の講習授業を追加します：\\n日付: ○月○日\\n時刻: ○:○○〜\\n教科: ○○\\n学年: ○○\\nよろしいですか？"}
