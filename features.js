...
${kbContext}${pricingContext}${campusListContext}${testNamesContext}${studentSummaryContext}${lecturePeriodsContext}${gradeCodesContext}${studentGradeYearContext}${operationsContext}${adminContext}
