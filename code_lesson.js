/**
 * code_lesson.js — レッスン名変更・一覧取得・不規則動詞データ管理
 * 役割: レッスン名更新 / レッスン一覧取得 / 不規則動詞（福速）保存・読込
 * 主要関数: updateLessonName, getLessonList, getLessonListForSave, saveFukisokuData, loadFukisokuData
 */
