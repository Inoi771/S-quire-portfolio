...
| **Phase 1 前準備** | オーナー側でFacebook/Instagram/Meta Businessの下準備 | 🔄 オーナー作業中 |
| **Phase 1** | Meta for Developers アプリ作成・トークン取得 | ⏸ オーナー作業完了待ち |
...
> マイグレーション SQL は Phase 2-a で必ずオーナー確認のうえ実行（CLAUDE.md「データ変更の慎重化」遵守）。
...
**承認日**: 2026-05-21
**次のアクション**: オーナー側下準備完了 → 新セッションで Phase 1 着手
